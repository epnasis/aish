...
| **view** | `resume` · `peek` · `history_more` · `sessions` · `models` · `files` · `jobs` · `dequeue` · `dequeue_cwd` · `share_drop` · `render_error` · `client_debug` |
