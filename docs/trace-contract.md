...
**#289 slice 1 (2026-08-25) added `frame` / `frame_skipped` to §3.4** — a reference to a picture of a driven page, stored in the media store rather than in the log, with the three states corollary 2 requires.
...
```json
{
  ...
  "frame": "/…/state/aish/media/ab12cd-browse-eon-pl.jpg",
  "frame_skipped": "",
